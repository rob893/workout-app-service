    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExerciseCategorysId = table.Column<int>(type: "int", nullable: false),
                    ExercisesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseExerciseCategory", x => new { x.ExerciseCategorysId, x.ExercisesId });
                    table.ForeignKey(
                        name: "FK_ExerciseExerciseCategory_ExerciseCategories_ExerciseCategory~",
                        column: x => x.ExerciseCategorysId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseStepNumber = table.Column<int>(type: "int", nullable: false),
